...
```
#> ✔ Setting active project to '/private/var/folders/l_/2mwm03p55zg7zjykv084hhvr0000gn/T/Rtmpo5JNd4/tempkg'
```
...
```
#> Updating roxygen version in /private/var/folders/l_/2mwm03p55zg7zjykv084hhvr0000gn/T/Rtmpo5JNd4/tempkg/DESCRIPTION
```
